<template>
  <div class="offcanvas offcanvas-end customeoff" tabindex="-1" id="addCustomers">
    <div class="offcanvas-header">
      <h5 class="modal-title" id="#gridSystemModal">Add Customer</h5>
          ...
          <div class="row">
            ...
            <div class="col-xl-6 mb-3">
              <label for="exampleFormControlInput3" class="form-label"
                >Employee Email<span class="text-danger">*</span></label
              >
              <input
                type="email"
                class="form-control"
            ...
            <div class="col-xl-6 mb-3">
              <label for="exampleFormControlInput88" class="form-label"
            ...
            <div class="col-xl-6 mb-3">
              <label for="exampleFormControlInput99" class="form-label"
