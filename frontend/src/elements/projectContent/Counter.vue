<template>
  <div class="col-xl-3 col-sm-6" v-for="({ img, color, num }, ind) in counterData" :key="ind">
    <div class="card box-hover">
      <div class="card-body">
        <div class="d-flex align-items-center">
          <div class="icon-box icon-box-lg bg-success-light rounded-circle" v-html="img"></div>
          <div class="total-projects ms-3">
            <h3 :class="`text-${color} count`">{{ num }}</h3>
