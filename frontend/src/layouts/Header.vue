        ...
        <div class="collapse navbar-collapse justify-content-between">
          ...
          <ul class="navbar-nav header-right">
            <li class="nav-item dropdown notification_dropdown">
              <a class="nav-link" href="?" data-bs-toggle="dropdown" v-html="headerSettingSvg"> </a>
                  ...
                  <ul class="timeline">
                    ...
                    <li>
                      ...
                      <RouterLink class="timeline-panel text-muted" to="?">
                        ...
                        <p class="mb-0">
                          Quisque RouterLink consequat ante Sit amet magna at volutapt...
                        </p>
                      </RouterLink>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <RouterLink class="timeline-panel text-muted" to="?">
                        <span>20 minutes ago</span>
                        <h6 class="mb-0">Mashable, RouterLink news website and blog, goes live.</h6>
                      </RouterLink>
                    </li>
                    <li>
                ...
                <div class="dropdown-menu dropdown-menu-end" style="">
                  <div class="card border-0 mb-0">
                    ...
                    <div class="card-footer px-0 py-2">
                      ...
                      <RouterLink to="/page-login" class="dropdown-item ai-icon">
                        <svg
                          class="profle-logout"
                          xmlns="http://www.w3.org/2000/svg"
                          width="18"
