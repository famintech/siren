<template>
  <CommonNavbar page="Form" path="Form Elements" />
      ...
      <div class="col-xl-6 col-lg-6">
        <div class="card">
          ...
          <div class="card-body">
            <div class="basic-form">
              <form>
                <FormSelectOptin class="wide mb-3 form-control-lg" :optionArray="options" />
                <FormSelectOptin class="wide mb-3" :optionArray="options" />
                <FormSelectOptin class="wide form-control-sm" :optionArray="options" />
              </form>
            </div>
          </div>
        </div>
...
import FormSelectOptin from '@/components/FormSelectOptin.vue'
import CommonNavbar from '@/layouts/CommonNavbar.vue'
import VueMultiselect from 'vue-multiselect'

export default defineComponent({
  name: 'formElements_',
  components: { FormSelectOptin, CommonNavbar, VueMultiselect },
  setup() {
    // @ts-ignore
    const options = ref([{ title: 'Option 1' }, { title: 'Option 2' }, { title: 'Option 3' }])
    return {
      options,
      selectNum: [{ title: 1 }, { title: 2 }, { title: 3 }]
    }
  }
})
</script>
