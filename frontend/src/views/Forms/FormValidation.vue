<template>
  <CommonNavbar page="Form" path="Validation" />
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            <div :class="`form-validation ${formValid ? 'was-validated' : ''}`">
                    ...
                    <div class="mb-3 row">
                      ...
                      <div class="col-lg-6">
                        <textarea
                          ...
                          required
                        ></textarea>
                        <div class="invalid-feedback">Please enter a Suggestions.</div>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-6">
                    ...
                    <div class="mb-3 row">
                      <label class="col-lg-4 col-form-label" for="validationCustom09"
                      ...
                      <div class="col-lg-6">
                        <input
                          ...
                          required
                        />
                        <div class="invalid-feedback">Please enter a digits.</div>
                      </div>
                    </div>
                    <div class="mb-3 row">
                      <label class="col-lg-4 col-form-label" for="validationCustom10"
                      ...
                      <div class="col-lg-6">
                        <input
                          ...
                          required
                        />
                        <div class="invalid-feedback">Please enter a num.</div>
                      </div>
                    </div>
                    <div class="mb-3 row">
                      <label class="col-lg-4 col-form-label" for="validationCustom11"
                        >Range [1, 5]
                        <span class="text-danger">*</span>
                      </label>
                      <div class="col-lg-6">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="basic-form">
              <form
                :class="`form-valide-with-icon needs-validation ${formValid2 ? 'was-validated' : ''}`"
                novalidate
              ...
              >
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group transparent-append">
                    ...
                    />
                    <span
                      :class="`input-group-text show-pass ${showHide ? 'active' : ''}`"
...
export default defineComponent({
  ...
  setup() {
    ...
    const formValid2 = ref(false)
    const showHide = ref(false)
    const checkForm = () => {
      formValid.value = true
    }
    const checkForm2 = () => {
      formValid2.value = true
    }
    return { checkForm, formValid, formValid2, checkForm2, showHide }
  }
})
</script>
