      ...
      <div class="col-lg-12">
        <div class="card mt-3">
          <div class="card-header">
            Invoice <strong>18/07/2023</strong>
              ...
              <div class="mt-4 col-xl-6 col-lg-6 col-md-12 col-sm-12 d-flex justify-content-lg-end justify-content-md-center justify-content-xs-start">
                <div class="row align-items-center">
                  <div class="col-sm-9">
                    ...
                    <span>Please send exact amount: <strong class="d-block">0.15050000 BTC</strong> <strong>1DonateWffyhwAjskoEwXt83pHZxhLTr8H</strong></span
                    ><br />
                    <small class="text-muted">Current exchange rate 1BTC = $6590 USD</small>
                  </div>
                  <div class="col-sm-3 mt-3">
                    <img src="../../../assets/images/qrcode.png" alt="" class="img-fluid width110" />
                  </div>
                </div>
              </div>
            </div>
                ...
                <table class="table table-clear">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="right">
                        <strong class="text-black">$7.477,36</strong><br />
