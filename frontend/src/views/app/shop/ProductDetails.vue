<template>
  ...
  <div class="container-fluid mh-auto" style="min-height: 876px">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
                ...
                <div class="product-detail-content">
                  ...
                  <div class="new-arrival-content pr">
                    ...
                    <div class="comment-review star-rating d-flex">
                      <ul>
                        <li><i class="fa fa-star me-1"></i></li>
                        <li><i class="fa fa-star me-1"></i></li>
                        <li><i class="fa fa-star me-1"></i></li>
                        <li><i class="fa fa-star me-1"></i></li>
                        ...
                        <div class="size-filter">
                          ...
                          >
                            <input
                              ...
                              checked
                            />
                            <label class="btn btn-outline-primary sharp sharp-lg" for="btnradio1"
                              >XS</label
                            >

                            <input type="radio" class="btn-check" name="btnradio" id="btnradio2" />
                            <label class="btn btn-outline-primary sharp sharp-lg" for="btnradio2"
                              >SM</label
                            >

                            <input type="radio" class="btn-check" name="btnradio" id="btnradio3" />
                            <label class="btn btn-outline-primary sharp sharp-lg" for="btnradio3"
                              >MD</label
                            >

                            <input type="radio" class="btn-check" name="btnradio" id="btnradio4" />
                            <label class="btn btn-outline-primary sharp sharp-lg" for="btnradio4"
                              >LG</label
                            >

                            <input type="radio" class="btn-check" name="btnradio" id="btnradio5" />
                            <label class="btn btn-outline-primary sharp sharp-lg" for="btnradio5"
                              >XL</label
                            >
                          </div>
                        </div>
