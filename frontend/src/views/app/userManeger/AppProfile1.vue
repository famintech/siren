<template>
  <CommonNavbar page="App" path="Profile" />

  <div class="container-fluid vh-900">
    <div class="row">
      <div class="col-lg-12">
              ...
              <div class="profile-details">
                ...
                <div class="dropdown ms-auto">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li class="dropdown-item">
                      <i class="fa fa-users text-primary me-2"></i> Add to close friends
                    </li>
                    <li class="dropdown-item">
              ...
              <div class="card-body">
                <div class="profile-statistics">
                  <div class="text-center">
                    ...
                    <div class="mt-4">
                      <a href="javascript:void(0);" class="btn btn-primary mb-1 me-2">Follow</a>
                      <a
            ...
            <div class="card">
              <div class="card-body">
                <div class="profile-blog">
                  ...
                  />
                  <h4>
                    <RouterLink to="/post-details" class="text-black"
                      >Darwin Creative Agency Theme</RouterLink
                    >
                  </h4>
                  <p class="mb-0">
                    ...
                    <div class="accordion-body">
                      <div class="profile-interest">
                        ...
                        >
                          ...
                          >
                            <img :src="img" alt="" class="px-1 py-1 img-fluid rounded" />
                          </a>
                        </Lightgallery>
                      </div>
                    </div>
                      ...
                      <div class="profile-news">
                        <div class="media pt-3 pb-3">
                          ...
                          <div class="media-body">
                            <h6 class="m-b-5">
                              <RouterLink to="/post-details" class="text-black"
                                >Collection of textile samples</RouterLink
                              >
                            </h6>
                            <p class="mb-0">
                ...
                <div class="tab-content">
                  <div id="my-posts" class="tab-pane fade active show">
                    <div class="my-post-content pt-3">
                      <div class="post-input">
                        ...
                        <a
                          href="javascript:void(0);"
                          class="btn btn-primary light me-2 px-3"
                          data-bs-toggle="modal"
                        ...
                        <div class="modal fade" id="linkModal">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <a class="btn-social facebook me-1" href="javascript:void(0)"
                                  ><i class="fab fa-facebook-f"></i
                                ></a>
                                <a class="btn-social google-plus me-1" href="javascript:void(0)"
                                  ><i class="fab fa-google-plus-g"></i
                                ></a>
                                <a class="btn-social linkedin me-1" href="javascript:void(0)"
                                  ><i class="fab fa-linkedin-in"></i
                                ></a>
                                <a class="btn-social instagram me-1" href="javascript:void(0)"
                                  ><i class="fab fa-instagram"></i
                                ></a>
                                <a class="btn-social twitter me-1" href="javascript:void(0)"
                                  ><i class="fab fa-twitter"></i
                                ></a>
                                <a class="btn-social youtube me-1" href="javascript:void(0)"
                                  ><i class="fab fa-youtube"></i
                                ></a>
                                <a class="btn-social whatsapp" href="javascript:void(0)"
                      ...
                      <div
                        class="profile-uoloaded-post border-bottom-1 pb-5"
                        v-for="({ img }, ind) in post"
                        :key="ind"
                      >
                        <img :src="img" alt="" class="img-fluid w-100 rounded" />
                        <RouterLink class="post-title" to="/post-details"
                          ><h3 class="text-black">
                        ...
                        <p>
                          ...
                          take possession of my entire soul like these sweet morning of spare which
                          enjoy whole heart.
                        </p>
                  ...
                  <div id="about-me" class="tab-pane fade">
                    ...
                    <div class="profile-skills mb-5">
                      ...
                      <a href="javascript:void(0);" class="btn btn-primary light btn-xs me-2"
                        >Admin</a
                      >
                      <a href="javascript:void(0);" class="btn btn-primary light btn-xs me-2"
                        >Dashboard</a
                    ...
                    <div class="profile-personal-info">
                      ...
                      <div class="row mb-2">
                        ...
                        <div class="col-sm-9 col-7"><span>Mitchell C.Shay</span></div>
                      </div>
                      <div class="row mb-2">
                        <div class="col-sm-3 col-5">
                          <h5 class="f-w-500">Email <span class="pull-end">:</span></h5>
                        </div>
                        <div class="col-sm-9 col-7"><span>example@examplel.com</span></div>
                      </div>
                      <div class="row mb-2">
                        <div class="col-sm-3 col-5">
                      ...
                      <div class="row mb-2">
                        <div class="col-sm-3 col-5">
                          <h5 class="f-w-500">Age <span class="pull-end">:</span></h5>
                        </div>
                      ...
                      <div class="row mb-2">
                        ...
                        <div class="col-sm-9 col-7"><span>07 Year Experiences</span></div>
                      </div>
                    </div>
                  </div>
...
export default defineComponent({
  name: 'appProfile_1',
  components: { Lightgallery, CommonNavbar, RouterLink, VueMultiselect },
  data: () => ({
    plugins: [lgThumbnail, lgZoom]
  }),
  setup() {
    return {
      post: [{ img: IMAGE.profilePic8 }, { img: IMAGE.profilePic9 }, { img: IMAGE.profilePic8 }],
      gallery: [
        { img: IMAGE.profilePic2 },
        { img: IMAGE.profilePic3 },
        { img: IMAGE.profilePic4 },
        { img: IMAGE.profilePic4 },
        { img: IMAGE.profilePic3 },
        { img: IMAGE.profilePic2 }
      ]
