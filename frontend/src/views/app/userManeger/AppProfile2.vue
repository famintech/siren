<template>
  <CommonNavbar page="App" path="Profile 2" />
        ...
        <div class="card card-profile">
          <div class="admin-user">
            <div class="img-wrraper">
              <div class="">
                <img src="../../../assets/images/user1.jpg" class="rounded-circle" alt="" />
              </div>
              <RouterLink class="icon-wrapper" to="/edit-profile"
                ><i class="fa-solid fa-pencil"></i
              ></RouterLink>
            </div>
            <div class="user-details">
              <div class="title">
                <a target="_blank" href="javascript:void(0)"> <h4>Thomas Fleming</h4></a>
                <h6>Web Designer</h6>
              </div>
              <ul class="user-social-links">
                ...
                <li>
                  <a href="javascript:void(0);"><i class="fa-brands fa-skype"></i></a>
                </li>
                <li>
              ...
              <ul class="follow-list">
                ...
                <li>
                  <div class="follow-num">450</div>
                  <span>Following</span>
                </li>
                <li>
                  <div class="follow-num">500</div>
                  <span>Likes</span>
                </li>
              </ul>
            </div>
                      ...
                      <div class="accordion-body">
                        <div class="about-me">
                          <ul>
                            ...
                            <li class="second-head" style="color: var(--secondary)">
                              social Networks
                            </li>
                          </ul>
                          <div>
                            <a href="javascript:void(0)" class="btn btn-block bg-facebook mb-2"
                              ><i class="fa-brands fa-facebook-f me-2"></i>Facebook</a
                            >
                            <a href="javascript:void(0)" class="btn btn-block bg-whatsapp mb-2"
                              ><i class="fa-brands fa-whatsapp me-2"></i>WhatsApp</a
                            >
                            <a href="javascript:void(0)" class="btn btn-block bg-facebook mb-2"
                              ><i class="fa-brands fa-skype me-2"></i>Skype</a
                            >
                          </div>
                        </div>
                      </div>
                    ...
                    >
                      <div class="accordion-body">
                        <div class="friend-list">
                          <img
                            src="../../../assets/images/profile/friends/f3.jpg"
                            class="avatar avatar-md"
                            alt=""
                          />
                          <img
                          ...
                          />
                          <img
                            src="../../../assets/images/profile/friends/f2.jpg"
                            class="avatar avatar-md"
                            alt=""
                          />
                          <img
                          ...
                          />
                          <img
                            src="../../../assets/images/profile/friends/f4.jpg"
                            class="avatar avatar-md"
                            alt=""
                          />
                          <img
        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-header border-0">
                <div class="products">
                  ...
                  <div>
                    <h5 class="mb-0">
                      <a href="javascript:void(0)" class="text-black">Thomas Fleming</a>
                    </h5>
              ...
              <div class="card-body pt-0">
                <div class="post-img">
                  <img src="../../../assets/images/post/post1.jpg" alt="" />
                </div>
                  ...
                  <li>
                    <label class="me-3"
                      ><a href="javascript:void(0)"
                        ><i class="fa-regular fa-heart me-2"></i>Like</a
                      ></label
                    >
                  </li>
                  <li>
                    <label class="me-3"
                      ><a href="javascript:void(0)"
                        ><i class="fa-regular fa-message me-2"></i>Comment</a
                      ></label
                    >
                  </li>
                  <li>
                    <label class="me-3"
                      ><a href="javascript:void(0)"
                        ><i class="fa-solid fa-share me-2"></i>Share</a
                      ></label
                    >
                  </li>
                </ul>
            ...
            <div class="card">
              ...
              <div class="card-body pt-0">
                <div class="row">
                  <div class="col-xl-6">
                    <div class="post-img">
                      <img src="../../../assets/images/post/post11.jpg" class="me-3" alt="" />
                    </div>
                  </div>
                  <div class="col-xl-6">
                    <div class="post-img">
                      <img src="../../../assets/images/post/post12.jpg" alt="" />
                    </div>
                  </div>
                </div>
                <div class="post-see d-flex align-items-center mt-3">
          ...
          <div class="col-xl-12">
            <div class="card">
              ...
              <div class="card-body pt-0">
                <div class="post-img">
                  <img src="../../../assets/images/post/post2.jpg" alt="" />
                </div>
                <div class="post-see d-flex align-items-center mt-3">
                  <ul>
                    <li class="avatar-list avatar-list-stacked">
            ...
            <div class="card">
              ...
              <div class="card-body pt-0">
                <div class="row">
                  <div class="col-xl-6">
                    <div class="post-img">
                      <img src="../../../assets/images/post/post12.jpg" class="me-3" alt="" />
                    </div>
                  </div>
                  <div class="col-xl-6">
                    <div class="post-img">
                      <img src="../../../assets/images/post/post13.jpg" alt="" />
                    </div>
                  </div>
                </div>
                <div class="post-see d-flex align-items-center mt-3">
...
export default defineComponent({
  name: 'appProfile',
  components: { Lightgallery, CommonNavbar, RouterLink },
  setup() {
    return {
      gallery: [
