                        ...
                        <div class="read-wapper dz-scroll" id="read-content">
                          <div class="read-content">
                            ...
                            <div class="read-content-body">
                              ...
                              <p class="mb-2">
                                <strong>Ingredia Nutrisha,</strong> A collection of textile samples
                                lay spread out on the table - Samsa was a travelling salesman - and
                                above it there hung a picture
                              </p>
                              <p class="mb-2">
                                Even the all-powerful Pointing has no control about the blind texts
                                it is an almost unorthographic life One day however a small line of
                                blind text by the name of Lorem Ipsum decided to leave for the far
                                World of Grammar. Aenean vulputate eleifend tellus. Aenean leo
                            ...
                            <div class="read-content-attachment">
                              <button class="btn btn-primary btn-sm">
                                <i class="fa-solid fa-forward me-1"></i>Forward
                              </button>
                              {{ ' ' }}
                          ...
                          <div class="text-end">
                            <button class="btn btn-primary mb-3" type="button">Send</button>
                          </div>
                        </div>
                      </div>
                    </div>
