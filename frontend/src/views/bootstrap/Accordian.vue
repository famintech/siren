<template>
  <CommonNavbar page="Bootstrap" path="Accordion" />
    ...
    <div class="element-area">
      <div class="demo-view">
        <div class="container-fluid pt-0 ps-0 pe-lg-4 pe-0">
          <div class="row">
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="accordion-one">
...
&lt;/div&gt;</code></pre>
          ...
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="accordion-two">
  ...
  &lt;/div&gt;</code></pre>
          ...
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="accordion-three">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
              ...
              <div class="tab-content" id="myTabContent-2">
                ...
                >
                  <div class="card-body pt-0 p-0 code-area">
                    <pre
                      class="mb-0"
                    ><code class="language-html">&lt;div class="accordion accordion-no-gutter accordion-header-bg scrollAccordian" id="accordion-three"&gt;
	&lt;div class="accordion-item"&gt;
	...
	&lt;/div&gt;</code></pre>
          ...
          <!-- Column starts -->
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="accordion-four">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
              ...
              <div class="tab-content" id="myTabContent-3">
                ...
                >
                  <div class="card-body pt-0 p-0 code-area">
                    <pre
                      class="mb-0"
                    ><code class="language-html">&lt;div class="accordion accordion-no-gutter accordion-bordered scrollAccordian" id="accordion-four"&gt;
    &lt;div class="accordion-item"&gt;
    ...
    &lt;/div&gt;</code></pre>
          ...
          <!-- Column starts -->
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="accordion-five">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                  <h4 class="card-title">Accordion indicator in left position</h4>
                  <p class="m-0 subtitle">
                    Add <code>accordion-start-indicator</code> class with <code>accordion</code>
                  </p>
                </div>
              ...
              <div class="tab-content" id="myTabContent-4">
                ...
                >
                  <div class="card-body pt-0 p-0 code-area">
                    <pre
                      class="mb-0"
                    ><code class="language-html">&lt;div class="accordion accordion-start-indicator scrollAccordian" id="accordion-five"&gt;
    &lt;div class="accordion-item"&gt;
    ...
    &lt;/div&gt;
          ...
          <!-- Column starts -->
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="accordion-six">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
              ...
              <div class="tab-content" id="myTabContent-5">
                    ...
                    <div class="accordion accordion-with-icon">
                      <div class="accordion-item">
                        <div
                          ...
                          id="accord-6One"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse6One"
                          aria-controls="collapse6One"
                          aria-expanded="true"
                          role="button"
                        >
                          <span class="accordion-header-icon"></span>
                      ...
                      <div class="accordion-item">
                        <div
                          ...
                          id="accord-6Two"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse6Two"
                          aria-controls="collapse6Two"
                          aria-expanded="true"
                          role="button"
                        >
                          <span class="accordion-header-icon"></span>
                      ...
                      <div class="accordion-item">
                        <div
                          ...
                          id="accord-6Three"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse6Three"
                          aria-controls="collapse6Three"
                          aria-expanded="true"
                          role="button"
                        >
                          <span class="accordion-header-icon"></span>
                ...
                >
                  <div class="card-body pt-0 p-0 code-area">
                    <pre
                      class="mb-0"
                    ><code class="language-html">&lt;div class="accordion accordion-with-icon scrollAccordian" id="accordion-six"&gt;
&lt;div class="accordion-item"&gt;
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Column starts -->
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="accordion-seven">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                  <h4 class="card-title">Accordion header background</h4>
                  <p class="m-0 subtitle">
                    Add <code>accordion-header-bg</code> class with <code>accrodion</code>
                  </p>
                </div>
                <ul class="nav nav-tabs dzm-tabs" id="myTab-6" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      id="home-tab-6"
                      data-bs-toggle="tab"
                      data-bs-target="#headerbackground"
                      type="button"
                      role="tab"
                      aria-selected="true"
                    >
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      id="profile-tab-6"
                      data-bs-toggle="tab"
                      data-bs-target="#headerbackground-html"
                      type="button"
                      role="tab"
                      aria-selected="false"
                    >
              ...
              <div class="tab-content" id="myTabContent-6">
                    ...
                    <div class="accordion accordion-header-bg accordion-bordered">
                      <div class="accordion-item">
                        <div
                          ...
                          id="accord-7One"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse7One"
                          aria-controls="collapse7One"
                          aria-expanded="true"
                          role="button"
                        >
                          <span class="accordion-header-icon"></span>
                      ...
                      <div class="accordion-item">
                        <div
                          ...
                          id="accord-7Two"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse7Two"
                          aria-controls="collapse7Two"
                          aria-expanded="true"
                          role="button"
                        >
                          <span class="accordion-header-icon"></span>
                      ...
                      <div class="accordion-item">
                        <div
                          ...
                          id="accord-7Three"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse7Three"
                          aria-controls="collapse7Three"
                          aria-expanded="true"
                          role="button"
                        >
                          <span class="accordion-header-icon"></span>
                ...
                >
                  <div class="card-body pt-0 p-0 code-area">
                    <pre
                      class="mb-0"
                    ><code class="language-html">&lt;div class="accordion accordion-header-bg accordion-bordered scrollAccordian" id="accordion-seven"&gt;
&lt;div class="accordion-item"&gt;
...
&lt;/div&gt;</code></pre>
          ...
          <!-- Column starts -->
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="accordion-eight">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                  <h4 class="card-title">Accordion solid background</h4>
                  <p class="m-0 subtitle">
                    Add class <code>accordion-solid-bg</code> with <code>accordion</code>
                  </p>
                </div>
                <ul class="nav nav-tabs dzm-tabs" id="myTab-7" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      id="home-tab-7"
                      data-bs-toggle="tab"
                      data-bs-target="#solidbackground"
                      type="button"
                      role="tab"
                      aria-selected="true"
                    >
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      id="profile-tab-7"
                      data-bs-toggle="tab"
                      data-bs-target="#solidbackground-html"
                      type="button"
                      role="tab"
                      aria-selected="false"
                    >
              ...
              <div class="tab-content" id="myTabContent-7">
                ...
                >
                  <div class="card-body pt-0 p-0 code-area">
                    <pre
                      class="mb-0"
                    ><code class="language-html">&lt;div class="accordion accordion-solid-bg scrollAccordian" id="accordion-eight"&gt;
    &lt;div class="accordion-item"&gt;
    ...
    &lt;/div&gt;</code></pre>
          ...
          <!-- Column starts -->
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="accordion-nine">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                  <h4 class="card-title">Accordion active background</h4>
                  <p class="m-0 subtitle">
                    Add class <code>accordion-active-header</code> with <code>accordion</code>
                  </p>
                </div>
                <ul class="nav nav-tabs dzm-tabs" id="myTab-8" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      id="home-tab-8"
                      data-bs-toggle="tab"
                      data-bs-target="#activebackground"
                      type="button"
                      role="tab"
                      aria-selected="true"
                    >
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      id="profile-tab-8"
                      data-bs-toggle="tab"
                      data-bs-target="#activebackground-html"
                      type="button"
                      role="tab"
                      aria-selected="false"
                    >
                    ...
                    <div class="accordion accordion-active-header">
                      <div class="accordion-item">
                        <div
                          ...
                          id="accord-9One"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse9One"
                          aria-controls="collapse9One"
                          aria-expanded="true"
                          role="button"
                        >
                          <span class="accordion-header-icon"></span>
                      ...
                      <div class="accordion-item">
                        <div
                          ...
                          id="accord-9Two"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse9Two"
                          aria-controls="collapse9Two"
                          aria-expanded="true"
                          role="button"
                        >
                          <span class="accordion-header-icon"></span>
                      ...
                      <div class="accordion-item">
                        <div
                          ...
                          id="accord-9Three"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse9Three"
                          aria-controls="collapse9Three"
                          aria-expanded="true"
                          role="button"
                        >
                          <span class="accordion-header-icon"></span>
    ...
    &lt;/div&gt;
          ...
          <!-- Column starts -->
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="accordion-ten">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-9" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      id="profile-tab-9"
                      data-bs-toggle="tab"
                      data-bs-target="#headerShadow-html"
                      type="button"
                      role="tab"
                      aria-selected="false"
                    >
              ...
              <div class="tab-content" id="myTabContent-9">
                    ...
                    <div class="accordion accordion-header-shadow accordion-rounded">
                      <div class="accordion-item">
                        <div
                          ...
                          id="accord-10One"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse10One"
                          aria-controls="collapse10One"
                          aria-expanded="true"
                          role="button"
                        >
                          <span class="accordion-header-icon"></span>
                      ...
                      <div class="accordion-item">
                        <div
                          ...
                          id="accord-10Two"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse10Two"
                          aria-controls="collapse10Two"
                          aria-expanded="true"
                          role="button"
                        >
                          <span class="accordion-header-icon"></span>
                      ...
                      <div class="accordion-item">
                        <div
                          ...
                          id="accord-10Three"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse10Three"
                          aria-controls="collapse9Three"
                          aria-expanded="true"
                          role="button"
                        >
                        ...
                        <div
                          id="collapse10Three"
                          class="collapse accordion__body"
                          aria-labelledby="accord-10Three"
                          data-bs-parent="#accordion-ten"
                        >
                          <div class="accordion-body-text">
                            Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus
                ...
                >
                  <div class="card-body pt-0 code-area">
                    <pre
                      class="mb-0"
                    ><code class="language-html">&lt;div class="accordion accordion-header-shadow accordion-rounded scrollAccordian" id="accordion-ten"&gt;
    &lt;div class="accordion-item"&gt;
    ...
    &lt;/div&gt;</code></pre>
          ...
          <!-- Column starts -->
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="accordion-eleven">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-10" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      id="profile-tab-10"
                      data-bs-toggle="tab"
                      data-bs-target="#roundedStylish-html"
                      type="button"
                      role="tab"
                      aria-selected="false"
                    >
              ...
              <div class="tab-content" id="myTabContent-10">
                ...
                >
                  <div class="card-body pt-0 p-0 code-area">
                    <pre
                      class="mb-0"
                    ><code class="language-html">&lt;div class="accordion accordion-rounded-stylish accordion-bordered scrollAccordian" id="accordion-eleven"&gt;
    &lt;div class="accordion-item"&gt;
    ...
    &lt;/div&gt;</code></pre>
          ...
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="accordion-twelve">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
              ...
              <div class="tab-content" id="myTabContent-11">
                    ...
                    <div class="accordion accordion-rounded-stylish accordion-gradient">
                      ...
                      <div class="accordion-item">
                        <div
                          ...
                          id="accord-12Two"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse12Two"
                          aria-controls="collapse12Two"
                          aria-expanded="true"
                          role="button"
                        >
                          <span class="accordion-header-icon"></span>
                      ...
                      <div class="accordion-item">
                        <div
                          ...
                          id="accord-12Three"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse12Three"
                          aria-controls="collapse12Three"
                          aria-expanded="true"
                          role="button"
                        >
                          <span class="accordion-header-icon"></span>
                        ...
                        <div
                          id="collapse12Three"
                          class="collapse accordion__body"
                          aria-labelledby="accord-12Three"
                          data-bs-parent="#accordion-twelve"
                        >
                          <div class="accordion-body-text">
                            Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus
                ...
                >
                  <div class="card-body pt-0 p-0 code-area">
                    <pre
                      class="mb-0"
                    ><code class="language-html">&lt;div class="accordion accordion-rounded-stylish accordion-gradient scrollAccordian" id="accordion-twelve"&gt;
&lt;div class="accordion-item"&gt;
