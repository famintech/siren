<template>
  <CommonNavbar page="Bootstrap" path="Carousel" />
    ...
    <div class="element-area">
      <div class="demo-view">
        <div class="container-fluid pt-0 ps-0 pe-lg-4 pe-0">
          <div class="row">
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="slides-only">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab"
                        data-bs-toggle="tab"
                        data-bs-target="#SlidesOnly-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel"&gt;
	&lt;div class="carousel-indicators"&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="with-captions">
                <div class="card-header flex-wrap border-0 pb-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-1" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-1"
                        data-bs-toggle="tab"
                        data-bs-target="#WithCaptions-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent-1">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;div class="bootstrap-carousel"&gt;
	&lt;div class="carousel slide" data-bs-ride="carousel"&gt;
		&lt;div class="carousel-inner"&gt;
			&lt;div class="carousel-item active"&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="slides-only-1">
                <div class="card-header flex-wrap border-0 pb-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-2" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-2"
                        data-bs-toggle="tab"
                        data-bs-target="#SlidesOnly2-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
...
&lt;/div&gt;</code></pre>
            ...
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="slides-indicators">
                <div class="card-header flex-wrap border-0 pb-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-3" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab-3"
                        data-bs-toggle="tab"
                        data-bs-target="#SlidesIndicators"
                        type="button"
                        role="tab"
                        aria-selected="true"
                      >
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-3"
                        data-bs-toggle="tab"
                        data-bs-target="#SlidesIndicators-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
...
&lt;/div&gt;</code></pre>
            ...
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="slides-captions">
                <div class="card-header flex-wrap border-0 pb-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-4" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-4"
                        data-bs-toggle="tab"
                        data-bs-target="#SlidesCaptions-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
        ...
        <div class="demo-right-inner dz-scroll" id="right-sidebar">
          ...
          <div class="dz-scroll demo-right-tabs" id="rightSidebarScroll">
            <ul class="navbar-nav" id="menu-bar">
              <li>
                <a @click="scrollView(0)" href="javascript:void(0)" class="scroll">Slides Only</a>
              </li>
              <li>
                <a @click="scrollView(1)" href="javascript:void(0)" class="scroll">With Captions</a>
              </li>
              <li>
                <a @click="scrollView(2)" href="javascript:void(0)" class="scroll">slides only-1</a>
              </li>
              <li>
                <a @click="scrollView(3)" href="javascript:void(0)" class="scroll"
                  >Slides With indicators</a
                >
              </li>
              <li>
                <a @click="scrollView(4)" href="javascript:void(0)" class="scroll"
                  >Slides With captions</a
                >
              </li>
            </ul>
          </div>
