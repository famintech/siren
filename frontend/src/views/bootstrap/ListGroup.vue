<template>
  <CommonNavbar page="Bootstrap" path="List Group" />
  <div class="container-fluid">
    <div class="element-area">
      <div class="demo-view">
        <div class="container-fluid pt-0 ps-0 pe-lg-4 pe-0">
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="basic-list">
              ...
              <div class="tab-content" id="myTabContent">
                ...
                >
                  <div class="card-body p-0 code-area">
                    <pre
                      class="m-0"
                    ><code class="language-html">&lt;div class="basic-list-group"&gt;
		&lt;ul class="list-group"&gt;
			&lt;li class="list-group-item"&gt;Cras justo odio&lt;/li&gt;
			&lt;li class="list-group-item"&gt;Dapibus ac facilisis in&lt;/li&gt;
			&lt;li class="list-group-item"&gt;Morbi leo risus&lt;/li&gt;
	...
	&lt;/div&gt;</code></pre>
          ...
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="list-active">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab1" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      id="profile-tab1"
                      data-bs-toggle="tab"
                      data-bs-target="#ListActive-html"
                      type="button"
                      role="tab"
                      aria-selected="false"
                    >
	...
	&lt;/div&gt;</code></pre>
          ...
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="list-disabled">
              <div class="card-header flex-wrap d-flex justify-content-between le">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab8" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      id="profile-tab8"
                      data-bs-toggle="tab"
                      data-bs-target="#ListDisabled-html"
                      type="button"
                      role="tab"
                      aria-selected="false"
                    >
	...
	&lt;/div&gt;</code></pre>
          ...
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="link-button">
              <div class="card-header flex-wrap d-flex justify-content-between le">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab2" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      id="profile-tab2"
                      data-bs-toggle="tab"
                      data-bs-target="#LinksButtons-html"
                      type="button"
                      role="tab"
                      aria-selected="false"
                    >
	...
	&lt;/div&gt;</code></pre>
          ...
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="flush">
              <div class="card-header flex-wrap d-flex justify-content-between le">
	...
	&lt;/div&gt;</code></pre>
          ...
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="with-badges">
              <div class="card-header flex-wrap d-flex justify-content-between le">
	...
	&lt;/div&gt;</code></pre>
          ...
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="custom-content">
              <div class="card-header flex-wrap d-flex justify-content-between le">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab5" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      id="profile-tab5"
                      data-bs-toggle="tab"
                      data-bs-target="#CustomContent-html"
                      type="button"
                      role="tab"
                      aria-selected="false"
                    >
                      ...
                      <div class="list-group">
                        ...
                        >
                          <div class="d-flex w-100 justify-content-between">
                            <h5 class="mb-3 text-white">List group item heading</h5>
	...
	&lt;/div&gt;</code></pre>
          ...
          <div class="col-xl-12">
            <div class="card dz-card scrollAccordian" id="contextual">
              <div class="card-header flex-wrap d-flex justify-content-between le">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab6" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      id="profile-tab6"
                      data-bs-toggle="tab"
                      data-bs-target="#Contextual-html"
                      type="button"
                      role="tab"
                      aria-selected="false"
                    >
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card dz-card scrollAccordian" id="list-tab">
                <div class="card-header flex-wrap d-flex justify-content-between le">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                              <div class="tab-pane fade show active" id="list-home">
                                ...
                                <p>
                                  ...
                                  reprehenderit occaecat nisi ad non minim tempor sunt voluptate
                                  consectetur exercitation id ut nulla. Ea et fugiat aliquip nostrud
                                  sunt incididunt consectetur culpa aliquip eiusmod dolor. Anim ad
                                  Lorem aliqua in cupidatat nisi enim eu nostrud do aliquip veniam
                                  minim.
                                </p>
                              </div>
                              ...
                              <div class="tab-pane fade" id="list-settings">
                                ...
                                <p>
                                  ...
                                  occaecat aute est cupidatat aliqua labore aute occaecat ea aliquip
                                  sunt amet. Aute mollit dolor ut exercitation irure commodo non
                                  amet consectetur quis amet culpa. Quis ullamco nisi amet qui aute
                                  irure eu. Magna labore dolor quis ex labore id nostrud deserunt
            ...
            <ul class="navbar-nav" id="menu-bar">
              ...
              <li>
                <a @click="scrollView(2)" href="javascript:void(0)" class="scroll"
                  >List Disabled Item</a
                >
              </li>
              <li>
                <a @click="scrollView(3)" href="javascript:void(0)" class="scroll"
                  >Link And Button Item</a
                >
              </li>
              <li><a @click="scrollView(4)" href="javascript:void(0)" class="scroll">Flush</a></li>
              <li>
                <a @click="scrollView(5)" href="javascript:void(0)" class="scroll">With Badges</a>
              </li>
              <li>
              ...
              <li>
                <a @click="scrollView(7)" href="javascript:void(0)" class="scroll">Contextual</a>
              </li>
              <li>
                <a @click="scrollView(8)" href="javascript:void(0)" class="scroll">List-Tab</a>
              </li>
            </ul>
          </div>
        </div>
