<template>
  <CommonNavbar page="Bootstrap" path="Grid" />
        ...
        <div class="card">
          ...
          <div class="card-body">
            <p>
              ...
              container widths. This is because the viewport width is in pixels and does not change
              with the font size. See how aspects of the Bootstrap grid system work across multiple
