<template>
  <CommonNavbar page="Bootstrap" path="Dropdown" />
    ...
    <div class="element-area">
      <div class="demo-view">
        <div class="container-fluid pt-0 ps-0 pe-lg-4 pe-0">
          <div class="row">
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="basic-dropdown">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab"
                        data-bs-toggle="tab"
                        data-bs-target="#BasicDropdown-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;div class="basic-dropdown"&gt;
	&lt;div class="dropdown"&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="#dropdown-divider">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab1" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab1"
                        data-bs-toggle="tab"
                        data-bs-target="#DropdownDivider"
                        type="button"
                        role="tab"
                        aria-selected="true"
                      >
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab1"
                        data-bs-toggle="tab"
                        data-bs-target="#DropdownDivider-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
...
&lt;/div&gt;</code></pre>
            ...
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="dropdown-header">
                <div class="card-header flex-wrap border-0">
                  <div>
                    <h4 class="card-title">Dropdown Header</h4>
                    <p class="m-0 subtitle">
                      The <code>.dropdown-header</code> class is used to add headers inside the
                      dropdown menu
                    </p>
                  </div>
                  <ul class="nav nav-tabs dzm-tabs" id="myTab3" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab3"
                        data-bs-toggle="tab"
                        data-bs-target="#DropdownHeader-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
...
&lt;/div&gt;</code></pre>
            ...
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="disable-active">
                <div class="card-header flex-wrap border-0">
                  <div>
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab4" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab4"
                        data-bs-toggle="tab"
                        data-bs-target="#DisableActive-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
...
&lt;/div&gt;</code></pre>
            ...
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="align-right">
                <div class="card-header flex-wrap border-0">
                  <div>
                    <h4 class="card-title">Align Right</h4>
                    <p class="m-0 subtitle">
                      To right-align the dropdown, add the <code>.dropdown-menu-end</code> class to
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab5" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab5"
                        data-bs-toggle="tab"
                        data-bs-target="#AlignRight-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
...
&lt;/div&gt;</code></pre>
            ...
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="dropup">
                <div class="card-header flex-wrap border-0">
                  <div>
                    <h4 class="card-title">Dropup</h4>
                    <p class="m-0 subtitle">
                      The <code>.dropup</code> class makes the dropdown menu expand upwards instead
                      of downwards
                    </p>
                  </div>
                  ...
                  >
                    <div class="card-body pt-0">
                      <div class="basic-dropdown">
                        ...
                        <div class="btn-group dropup mb-1">
                          <button type="button" class="btn mb-2 btn-primary">Split dropup</button>
                          <button
                            type="button"
                            class="btn mb-2 btn-primary dropdown-toggle dropdown-toggle-split"
                            data-bs-toggle="dropdown"
                          >
...
&lt;/div&gt;</code></pre>
            ...
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="dropright">
                <div class="card-header flex-wrap border-0">
                  <div>
...
&lt;/div&gt;</code></pre>
            ...
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="dropstart">
                <div class="card-header flex-wrap border-0">
                  <div>
...
&lt;/div&gt;</code></pre>
            ...
            <div class="col-xl-12" id="button-dropdowns">
              <div class="card dz-card scrollAccordian">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab9" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab9"
                        data-bs-toggle="tab"
                        data-bs-target="#ButtonDropdowns"
                        type="button"
                        role="tab"
                        aria-selected="true"
                      >
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab9"
                        data-bs-toggle="tab"
                        data-bs-target="#ButtonDropdowns-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent9">
                    ...
                    <div class="card-body pt-0">
                      <div class="button-dropdown">
                        <div class="btn-group mb-1">
                          ...
                          <button
                            type="button"
                            class="btn me-2 mb-2 btn-primary dropdown-toggle dropdown-toggle-split"
                            data-bs-toggle="dropdown"
                          ></button>
                          <div class="dropdown-menu">
                        ...
                        <div class="btn-group mb-1">
                          ...
                          <button
                            type="button"
                            class="btn me-2 mb-2 btn-secondary dropdown-toggle dropdown-toggle-split"
                            data-bs-toggle="dropdown"
                          ></button>
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="javascript:void(0);">Action</a>
                        ...
                        <div class="btn-group mb-1">
                          ...
                          <button
                            type="button"
                            class="btn me-2 mb-2 btn-success dropdown-toggle dropdown-toggle-split"
                            data-bs-toggle="dropdown"
                          ></button>
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="javascript:void(0);">Action</a>
                        ...
                        <div class="btn-group mb-1">
                          ...
                          <button
                            type="button"
                            class="btn me-2 mb-2 btn-info dropdown-toggle dropdown-toggle-split"
                            data-bs-toggle="dropdown"
                          ></button>
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="javascript:void(0);">Action</a>
                        ...
                        <div class="btn-group mb-1">
                          ...
                          <button
                            type="button"
                            class="btn me-2 mb-2 btn-warning dropdown-toggle dropdown-toggle-split"
                            data-bs-toggle="dropdown"
                          ></button>
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="javascript:void(0);">Action</a>
                        ...
                        <div class="btn-group mb-1">
                          ...
                          <button
                            type="button"
                            class="btn me-2 mb-2 btn-danger dropdown-toggle dropdown-toggle-split"
                            data-bs-toggle="dropdown"
                          ></button>
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="javascript:void(0);">Action</a>
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      > <code class="language-html">&lt;div class="button-dropdown"&gt;
&lt;div class="btn-group mb-1"&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="sizing">
                <div class="card-header flex-wrap border-0">
                  <div>
                ...
                <div class="tab-content" id="myTabContent10">
                  ...
                  >
                    <div class="card-body pt-0">
                      <div class="dropdown-size">
                        ...
                        <div class="btn-group mb-1">
                          <button
                            class="btn me-2 mb-2 btn-primary btn-lg dropdown-toggle"
                            type="button"
                            data-bs-toggle="dropdown"
                          >
                            Large button
                        ...
                        <div class="btn-group mb-1">
                          <button class="btn mb-2 btn-primary btn-lg" type="button">
                            Large split button
                          </button>
                          <button
                            type="button"
                            class="btn me-2 mb-2 btn-lg btn-primary dropdown-toggle dropdown-toggle-split"
                            data-bs-toggle="dropdown"
                            aria-haspopup="true"
                            aria-expanded="false"
                          >
                        ...
                        <div class="btn-group mb-1">
                          <button
                            class="btn me-2 mb-2 btn-primary btn-sm dropdown-toggle"
                            type="button"
                            data-bs-toggle="dropdown"
                          >
                            Small button
                        ...
                        <div class="btn-group mb-1">
                          <button class="btn mb-2 btn-primary btn-sm" type="button">
                            Small split button
                          </button>
                          <button
                            type="button"
                            class="btn me-2 mb-2 btn-sm btn-primary dropdown-toggle dropdown-toggle-split"
                            data-bs-toggle="dropdown"
                            aria-haspopup="true"
                            aria-expanded="false"
                          >
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      > <code class="language-html">&lt;div class="dropdown-size"&gt;
	&lt;!-- Large button groups (default and split) --&gt;
	&lt;div class="btn-group mb-1"&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <div class="col-lg-12">
              <div class="card dz-card scrollAccordian" id="custom-style">
                <div class="card-header flex-wrap border-0">
                  <div>
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab11" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab11"
                        data-bs-toggle="tab"
                        data-bs-target="#CustomStyle-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                      ...
                      <div class="row">
                        ...
                        <div class="col-xl-3 col-md-3 mb-3 col-sm-4 col-6">
                          <div class="dropdown custom-dropdown">
                            <button
                              type="button"
                              class="btn me-2 mb-2 btn-sm btn-outline-primary"
                              data-bs-toggle="dropdown"
                            >
                              Last 7 days
                              <i class="fa fa-angle-down ms-3"></i>
                        ...
                        <div class="col-xl-3 col-md-3 col-sm-4 col-6 mb-3 mb-sm-0">
                          <div class="dropdown custom-dropdown">
                            <button
                              type="button"
                              class="btn me-2 mb-2 btn-sm btn-primary"
                              data-bs-toggle="dropdown"
                            >
                              Last 7 days
                              <i class="fa fa-angle-down ms-3"></i>
                        ...
                        <div class="col-xl-3 col-md-3 col-sm-4 col-6 mb-3 mb-sm-0">
                          <div class="dropdown custom-dropdown">
                            <button
                              type="button"
                              class="btn me-2 mb-2 btn-sm btn-primary d-flex align-items-center"
                              data-bs-toggle="dropdown"
                            >
                        ...
                        <div class="col-xl-3 col-md-3 col-sm-4 col-6 mb-3 mb-sm-0">
                          <div class="dropdown custom-dropdown">
                            <button
                              type="button"
                              class="btn me-2 mb-2 btn-sm btn-primary flex-wrap"
                              data-bs-toggle="dropdown"
                            >
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                              <a class="dropdown-item" href="javascript:void(0);"
                                >May 20, 2018 &nbsp; To &nbsp; June 20, 2018</a
                              >
                              <a class="dropdown-item" href="javascript:void(0);"
                                >July 20, 2018 &nbsp; To &nbsp; August 20, 2018</a
                              >
                            </div>
                          </div>
                        </div>
                        <div class="col-xl-3 col-md-3 col-sm-4 col-6">
                          <div class="dropdown custom-dropdown">
                            <div
                              class="btn me-2 mb-2 sharp btn-primary tp-btn ms-3"
                              data-bs-toggle="dropdown"
                            >
                              <svg
                                width="22"
                        ...
                        <div class="col-xl-3 col-md-3 col-sm-4 col-6">
                          <div class="dropdown custom-dropdown">
                            <div
                              class="btn me-2 mb-2 sharp btn-primary tp-btn"
                              data-bs-toggle="dropdown"
                            >
                              <svg
                                width="22"
        ...
        <div class="demo-right-inner dz-scroll" id="right-sidebar">
          ...
          <div class="dz-scroll demo-right-tabs" id="rightSidebarScroll">
            <ul class="navbar-nav" id="menu-bar">
              ...
              <li>
                <a @click="scrollView(3)" href="javascript:void(0)" class="scroll">Align Right</a>
              </li>
              <li>
                <a @click="scrollView(4)" href="javascript:void(0)" class="scroll">Dropright</a>
              </li>
              <li>
                <a @click="scrollView(5)" href="javascript:void(0)" class="scroll">Dropstart</a>
              </li>
              <li>
              ...
              <li><a @click="scrollView(7)" href="javascript:void(0)" class="scroll">Sizing</a></li>
              <li>
                <a @click="scrollView(8)" href="javascript:void(0)" class="scroll">Custom Style</a>
              </li>
            </ul>
          </div>
        </div>
