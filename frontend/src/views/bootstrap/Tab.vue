<template>
  <CommonNavbar page="Bootstrap" path="Tab" />
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab"
                        data-bs-toggle="tab"
                        data-bs-target="#DefaultTab-html"
                        type="button"
                        role="tab"
                      >
                        HTML
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                          <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#home"
                              ><i class="la la-home me-2"></i> Home</a
                            >
                          </li>
                          <li class="nav-item">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#message"
                              ><i class="la la-envelope me-2"></i> Message</a
                            >
                          </li>
                        </ul>
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab1" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab1"
                        data-bs-toggle="tab"
                        data-bs-target="#DefaultTab1-html"
                        type="button"
                        role="tab"
                      >
                        HTML
                ...
                <div class="tab-content" id="myTabContent3">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;ul class="nav nav-pills mb-4 light"&gt;
	&lt;li class=" nav-item"&gt;
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab4" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab4"
                        data-bs-toggle="tab"
                        data-bs-target="#NavPillsTabs-html"
                        type="button"
                        role="tab"
                      >
                        HTML
                ...
                <div class="tab-content" id="myTabContent4">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      > <code class="language-html">&lt;ul class="nav nav-pills justify-content-end mb-4"&gt;
	&lt;li class=" nav-item"&gt;
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab5" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab5"
                        data-bs-toggle="tab"
                        data-bs-target="#VerticalNav-html"
                        type="button"
                        role="tab"
                      >
                        HTML
                          ...
                          <div class="tab-content">
                            ...
                            <div id="v-pills-messages" class="tab-pane fade">
                              <p>
                                ...
                                Velit et et proident Lorem do ea tempor officia dolor. Reprehenderit
                                Lorem aliquip labore est magna commodo est ea veniam consectetur.
                              </p>
                            </div>
                            <div id="v-pills-settings" class="tab-pane fade">
                              <p>
                                ...
                                do. Aliqua amet qui mollit consectetur nulla mollit velit aliqua
                                veniam nisi id do Lorem deserunt amet. Culpa ullamco sit adipisicing
                                labore officia magna elit nisi in aute tempor commodo eiusmod.
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab6" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab6"
                        data-bs-toggle="tab"
                        data-bs-target="#VerticalNavPill"
                        type="button"
                        role="tab"
                        aria-controls="home"
                        aria-selected="true"
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab6"
                        data-bs-toggle="tab"
                        data-bs-target="#VerticalNavPill-html"
                        type="button"
                        role="tab"
                      >
                        HTML
                        ...
                        <div class="col-sm-4">
                          <div class="nav flex-column nav-pills">
                            ...
                            <a href="#v-pills-profile1" data-bs-toggle="pill" class="nav-link"
                              >Profile</a
                            >
                            <a href="#v-pills-messages1" data-bs-toggle="pill" class="nav-link"
                              >Messages</a
                            >
                            <a href="#v-pills-settings1" data-bs-toggle="pill" class="nav-link"
                              >Settings</a
                            >
                          </div>
                        </div>
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab7" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab7"
                        data-bs-toggle="tab"
                        data-bs-target="#TabWithIcon-html"
                        type="button"
                        role="tab"
                      >
                        HTML
