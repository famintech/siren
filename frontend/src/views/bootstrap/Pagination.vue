<template>
  <CommonNavbar page="Bootstrap" path="Pagination" />
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab"
                        data-bs-toggle="tab"
                        data-bs-target="#DefaultPagination"
                        type="button"
                        role="tab"
                        aria-selected="true"
                      >
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab"
                        data-bs-toggle="tab"
                        data-bs-target="#DefaultPagination-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab1" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab1"
                        data-bs-toggle="tab"
                        data-bs-target="#PaginationGutter"
                        type="button"
                        role="tab"
                        aria-selected="true"
                      >
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab1"
                        data-bs-toggle="tab"
                        data-bs-target="#PaginationGutter-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab2" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab2"
                        data-bs-toggle="tab"
                        data-bs-target="#PaginationColor"
                        type="button"
                        role="tab"
                        aria-selected="true"
                      >
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab2"
                        data-bs-toggle="tab"
                        data-bs-target="#PaginationColor-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab3" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab3"
                        data-bs-toggle="tab"
                        data-bs-target="#PaginationCircle"
                        type="button"
                        role="tab"
                        aria-selected="true"
                      >
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab3"
                        data-bs-toggle="tab"
                        data-bs-target="#PaginationCircle-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
