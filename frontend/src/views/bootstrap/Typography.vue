<template>
  <CommonNavbar page="Bootstrap" path="ui-typography" />
            ...
            <div class="row justify-content-between">
              ...
              <div class="col-lg-6">
                <div class="mb-4">
                  ...
                  <p>
                    Use tags
                    <code>text-sm-start, text-md-start, text-lg-start, text-xl-start</code> for get
                    desire text.
                  </p>
                </div>
                <div class="card-content">
              ...
              <div class="col-lg-4 mb-3">
                ...
                <ul class="list-icons">
                  <li>
                    <span class="align-middle me-2"><i class="ti-angle-right"></i></span> Lorem
                    ipsum dolor sit amet
                  </li>
                  <li>
                    <span class="align-middle me-2"><i class="ti-angle-right"></i></span>
                    Consectetur adipiscing elit
                  </li>
                  <li>
                    <span class="align-middle me-2"><i class="ti-angle-right"></i></span> Integer
                ...
                <ul class="list-icons">
                  <li>
                    <a href="javascript:void(0)"
                      ><span class="align-middle me-2"><i class="fa fa-check text-info"></i></span>
              ...
              <div class="col-lg-4 mb-3">
                ...
                <ul class="list-icons">
                  <li>
                    <a href="javascript:void(0)"
                      ><span class="align-middle me-2"><i class="fa fa-chevron-right"></i></span>
                      Lorem ipsum dolor sit amet</a
                    >
                  </li>
                  <li>
