<template>
  <CommonNavbar page="Bootstrap" path="Progressbar" />
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab"
                        data-bs-toggle="tab"
                        data-bs-target="#DefaultProgressr"
                        type="button"
                        role="tab"
                        aria-selected="true"
                      >
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab"
                        data-bs-toggle="tab"
                        data-bs-target="#DefaultProgressr-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab1" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab1"
                        data-bs-toggle="tab"
                        data-bs-target="#StripedProgress"
                        type="button"
                        role="tab"
                        aria-selected="true"
                      >
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab1"
                        data-bs-toggle="tab"
                        data-bs-target="#StripedProgress-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab3" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab3"
                        data-bs-toggle="tab"
                        data-bs-target="#ColoredProgress"
                        type="button"
                        role="tab"
                        aria-selected="true"
                      >
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab3"
                        data-bs-toggle="tab"
                        data-bs-target="#ColoredProgress-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab4" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab4"
                        data-bs-toggle="tab"
                        data-bs-target="#Differentbar-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab5" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab5"
                        data-bs-toggle="tab"
                        data-bs-target="#AnimatedStriped"
                        type="button"
                        role="tab"
                        aria-selected="true"
                      >
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab5"
                        data-bs-toggle="tab"
                        data-bs-target="#AnimatedStriped-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent5">
                  ...
                  >
                    <div class="card-body pt-0">
                      <div class="progress mt-3">
                        <div
                          class="progress-bar active progress-bar-striped bg-danger"
                          style="width: 60%"
                          role="progressbar"
                        >
                          <span class="sr-only">60% Complete</span>
                      ...
                      <div class="progress mt-3">
                        <div
                          class="progress-bar bg-info active progress-bar-striped"
                          style="width: 40%"
                          role="progressbar"
                        >
                          <span class="sr-only">60% Complete</span>
                      ...
                      <div class="progress mt-3">
                        <div
                          class="progress-bar bg-success active progress-bar-striped"
                          style="width: 20%"
                          role="progressbar"
                        >
                          <span class="sr-only">60% Complete</span>
                      ...
                      <div class="progress mt-3">
                        <div
                          class="progress-bar bg-primary active progress-bar-striped"
                          style="width: 30%"
                          role="progressbar"
                        >
                          <span class="sr-only">60% Complete</span>
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab6" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab6"
                        data-bs-toggle="tab"
                        data-bs-target="#VerticalProgress"
                        type="button"
                        role="tab"
                        aria-selected="true"
                      >
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab6"
                        data-bs-toggle="tab"
                        data-bs-target="#VerticalProgress-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent6">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      > <code class="language-html">&lt;div class="progress progress-vertical"&gt;
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab7" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab7"
                        data-bs-toggle="tab"
                        data-bs-target="#Progressbottom-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent7">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      ><code class="lanuage-html">&lt;div class="progress progress-vertical-bottom"&gt;
	&lt;div class="progress-bar bg-danger" style="width:4px; height:60%;" role="progressbar"&gt;
		&lt;span class="sr-only"&gt;60% Complete&lt;/span&gt;
	&lt;/div&gt;
&lt;/div&gt;
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab8" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab8"
                        data-bs-toggle="tab"
                        data-bs-target="#DifferentSize-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab9" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab9"
                        data-bs-toggle="tab"
                        data-bs-target="#AnimatedBars-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent9">
                  ...
                  >
                    <div class="card-body pt-0">
                      <div class="progress mt-3">
                        <div
                          class="progress-bar bg-danger progress-animated"
                          style="width: 60%"
                          role="progressbar"
                        >
                          <span class="sr-only">60% Complete</span>
                      ...
                      <div class="progress mt-3">
                        <div
                          class="progress-bar bg-primary progress-animated"
                          style="width: 30%"
                          role="progressbar"
                        >
                          <span class="sr-only">60% Complete</span>
                      ...
                      <div class="progress mt-3">
                        <div
                          class="progress-bar bg-inverse progress-animated"
                          style="width: 40%"
                          role="progressbar"
                        >
                          <span class="sr-only">60% Complete</span>
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      > <code class="language-html">&lt;div class="progress mt-3"&gt;
        ...
        <div class="demo-right-inner dz-scroll" id="right-sidebar">
          ...
          <div class="dz-scroll demo-right-tabs" id="rightSidebarScroll">
            <ul class="navbar-nav" id="menu-bar">
              ...
              <li>
                <a href="#vertical-progress-bottom" class="scroll"
