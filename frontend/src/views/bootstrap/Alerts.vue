<template>
  <CommonNavbar page="Bootstrap" path="Alert" />
      ...
      <div class="demo-view">
        <div class="container-fluid pt-0 ps-0 pe-lg-4 pe-0">
          ...
          <div class="row">
            <!-- Column starts -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="basic-alerts">
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="color-alerts">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-1" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-1"
                        data-bs-toggle="tab"
                        data-bs-target="#colorAlerts-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent-1">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="mb-0"
                      ><code class="language-html">  &lt;div class="alert alert-primary solid alert-dismissible fade show"&gt;
    &lt;svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="me-2"&gt;&lt;circle cx="12" cy="12" r="10"&gt;&lt;/circle&gt;&lt;path d="M8 14s1.5 2 4 2 4-2 4-2"&gt;&lt;/path&gt;&lt;line x1="9" y1="9" x2="9.01" y2="9"&gt;&lt;/line&gt;&lt;line x1="15" y1="9" x2="15.01" y2="9"&gt;&lt;/line&gt;&lt;/svg&gt;
    &lt;strong&gt;Welcome!&lt;/strong&gt; Message has been sent.
    &lt;button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"&gt;
    &lt;/button&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="square-alerts">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-2" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-2"
                        data-bs-toggle="tab"
                        data-bs-target="#SquareAlerts-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent-2">
                  ...
                  >
                    <div class="card-body pt-0">
                      ...
                      <div class="alert alert-secondary solid alert-square">
                        <strong>Done!</strong> Your profile photo updated.
                      </div>
                      <div class="alert alert-success solid alert-square">
                        <strong>Success!</strong> Message has been sent.
                      </div>
                      <div class="alert alert-info solid alert-square">
                        <strong>Info!</strong> You have got 5 new email.
                      </div>
                      ...
                      <div class="alert alert-light solid alert-square">
                        <strong>Error!</strong> You successfully read this message..
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="mb-0"
                      ><code class="language-html">&lt;div class="alert alert-primary solid alert-square"&gt;&lt;strong&gt;Welcome!&lt;/strong&gt; Message has been sent.&lt;/div&gt;
...
&lt;div class="alert alert-light solid alert-square"&gt;&lt;strong&gt;Error!&lt;/strong&gt; You successfully read this message..&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="rounded-alerts">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-3" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-3"
                        data-bs-toggle="tab"
                        data-bs-target="#RoundedAlerts-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent-3">
                  ...
                  >
                    <div class="card-body pt-0">
                      ...
                      <div class="alert alert-info solid alert-rounded">
                        <strong>Info!</strong> You have got 5 new email.
                      </div>
                      <div class="alert alert-warning solid alert-rounded">
                        <strong>Warning!</strong> Something went wrong. Please check.
                      </div>
                      ...
                      <div class="alert alert-light solid alert-rounded">
                        <strong>Error!</strong> You successfully read this message..
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="mb-0"
                      ><code class="language-html">&lt;div class="alert alert-primary solid alert-rounded"&gt;&lt;strong&gt;Welcome!&lt;/strong&gt; Message has been sent.&lt;/div&gt;
...
&lt;div class="alert alert-light solid alert-rounded"&gt;&lt;strong&gt;Error!&lt;/strong&gt; You successfully read this message..&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="dismissable-alerts">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-4" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab-4"
                        data-bs-toggle="tab"
                        data-bs-target="#DismissableAlerts"
                        type="button"
                        role="tab"
                        aria-selected="true"
                      >
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-4"
                        data-bs-toggle="tab"
                        data-bs-target="#DismissableAlerts-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent-4">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="mb-0"
                      ><code class="language-html">&lt;div class="alert alert-primary alert-dismissible fade show"&gt;
    &lt;button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"&gt;
    &lt;/button&gt;
    &lt;strong&gt;Success!&lt;/strong&gt; Message has been sent.
&lt;/div&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="alerts-alt">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                ...
                <div class="tab-content" id="myTabContent-5">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="mb-0"
                      ><code class="language-html">&lt;div class="alert alert-primary alert-dismissible alert-alt fade show"&gt;
    &lt;button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"&gt;
    &lt;/button&gt;
    &lt;strong&gt;Success!&lt;/strong&gt; Message has been sent.
&lt;/div&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="solid-alt">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                ...
                <div class="tab-content" id="myTabContent-6">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="mb-0"
                      ><code class="language-html">&lt;div class="alert alert-primary alert-dismissible alert-alt solid fade show"&gt;
    &lt;button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"&gt;
    &lt;/button&gt;
    &lt;strong&gt;Success!&lt;/strong&gt; Message has been sent.
&lt;/div&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="dismissable-solid">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-7" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-7"
                        data-bs-toggle="tab"
                        data-bs-target="#Dismissable-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
    ...
    &lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="alert-link">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                  ...
                  >
                    <div class="card-body pt-0">
                      <div class="alert alert-primary alert-dismissible fade show">
                        ...
                        <a href="#">Please check this one as well</a>
                      </div>
...
&lt;/div&gt;
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="alert-link-color">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                  ...
                  >
                    <div class="card-body pt-0">
                      <div class="alert alert-primary solid alert-dismissible fade show">
                        ...
                        <a href="#" class="badge badge-sm light badge-primary ms-1">upgrade</a>
                      </div>
                      <div class="alert alert-secondary solid alert-dismissible fade show">
                        <button
                          type="button"
                        ...
                        WOW! Eveything looks OK.
                        <a href="#" class="badge badge-sm light badge-secondary ms-1">upgrade</a>
                      </div>
                      <div class="alert alert-success solid alert-dismissible fade show">
                        <button
                          type="button"
                        ...
                        WOW! Eveything looks OK.
                        <a href="#" class="badge badge-sm light badge-success ms-1">upgrade</a>
                      </div>
                      ...
                      <div class="alert alert-info solid alert-dismissible fade show">
                        ...
                        <a href="#" class="badge badge-sm light badge-info ms-1">upgrade</a>
                      </div>
                      <div class="alert alert-warning solid alert-dismissible fade show">
                        <button
                          type="button"
                        ...
                        <strong>Warning!</strong> Why you did it to me!
                        <a href="#" class="badge badge-sm light badge-warning ms-1">upgrade</a>
                      </div>
                      <div class="alert alert-danger solid alert-dismissible fade show">
                        <button
                          type="button"
                        ...
                        <strong>Error!</strong> Something Went wrong
                        <a href="#" class="badge badge-sm light badge-danger ms-1">upgrade</a>
                      </div>
                      <div class="alert alert-dark solid alert-dismissible fade show">
                        <button
                          type="button"
                        ...
                        <strong>Error!</strong> Something Went wrong
                        <a href="#" class="badge badge-sm light badge-dark ms-1">upgrade</a>
                      </div>
                      <div class="alert alert-light solid alert-dismissible fade show">
                        <button
                          type="button"
                        ...
                        <strong>Error!</strong> Something Went wrong
                        <a href="#" class="badge badge-sm light badge-light ms-1">upgrade</a>
                      </div>
                    </div>
                  </div>
                  <div
...
&lt;/div&gt;
            ...
            <!-- Column  -->
            <div class="col-lg-12">
              <div class="card dz-card scrollAccordian" id="notifications">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-10" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-10"
                        data-bs-toggle="tab"
                        data-bs-target="#Notifications-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                      ...
                      <div class="row">
                        ...
                        <div class="col-xl-6">
                          <div class="alert alert-danger notification">
                            ...
                            <p>
                              What is the loop of Creation? How is there something from nothing? In
                              spite of the fact..
                            </p>
...
&lt;/div&gt;</code> </pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="alert-icon-left">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                    <h4 class="card-title">Alert Icon Left</h4>
                    <p class="mb-0 subtitle">
                      add <code>.alert-end-icon</code> to change the style
                    </p>
                  </div>
                ...
                <div class="tab-content" id="myTabContent-11">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;div class="alert alert-primary solid alert-end-icon alert-dismissible fade show"&gt;
    &lt;span&gt;&lt;i class="mdi mdi-account-search"&gt;&lt;/i&gt;&lt;/span&gt;
    &lt;button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="alert-outline">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                    <h4 class="card-title">Alert Outline</h4>
                    <p class="mb-0 subtitle">
                      add <code>.alert-outline-primary,secondary,success...</code> to change the
                      style
                    </p>
                  </div>
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-12" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-12"
                        data-bs-toggle="tab"
                        data-bs-target="#AlertOutline-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
...
&lt;/div&gt;
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="alert-social">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                    <h4 class="card-title">Alert Social</h4>
                    <p class="mb-0 subtitle">
                      add <code>.alert-social .facebook,.twitter,.linkedin,.google-plus</code> to
                      change the style
                    </p>
                  </div>
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-13" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-13"
                        data-bs-toggle="tab"
                        data-bs-target="#AlertSocial-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="message-alert">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-14" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-14"
                        data-bs-toggle="tab"
                        data-bs-target="#AlertMessage-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="message-alert-color">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-15" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="home-tab-15"
                        data-bs-toggle="tab"
                        data-bs-target="#AlertSolidcolor"
                        type="button"
                        role="tab"
                        aria-selected="true"
                      >
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-15"
                        data-bs-toggle="tab"
                        data-bs-target="#AlertSolidcolor-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="alert-icon-big">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  <div>
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-16" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-16"
                        data-bs-toggle="tab"
                        data-bs-target="#AlertLeftIcon-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
        ...
        <div class="demo-right-inner dz-scroll" id="right-sidebar">
          ...
          <div class="dz-scroll demo-right-tabs" id="rightSidebarScroll">
            <ul class="navbar-nav" id="menu-bar">
              <li>
                <a @click="scrollView(0)" href="javascript:void(0)" class="scroll">Basic-Alerts</a>
              </li>
              <li>
                <a @click="scrollView(1)" href="javascript:void(0)" class="scroll"
                  >Solid color alerts</a
                >
              </li>
              <li>
                <a @click="scrollView(2)" href="javascript:void(0)" class="scroll">Square Alerts</a>
              </li>
              <li>
                <a @click="scrollView(3)" href="javascript:void(0)" class="scroll"
                  >Rounded Alerts</a
                >
              </li>
              <li>
                <a @click="scrollView(4)" href="javascript:void(0)" class="scroll"
                  >Dismissable Alerts</a
                >
              </li>
              <li>
                <a @click="scrollView(5)" href="javascript:void(0)" class="scroll">Alerts Alt</a>
              </li>
              <li>
                <a @click="scrollView(6)" href="javascript:void(0)" class="scroll">Solid Alt</a>
              </li>
              <li>
                <a @click="scrollView(7)" href="javascript:void(0)" class="scroll"
                  >Dismissable with solid</a
                >
              </li>
              <li>
                <a @click="scrollView(8)" href="javascript:void(0)" class="scroll"
                  >Alert with Link</a
                >
              </li>
              <li>
                <a @click="scrollView(9)" href="javascript:void(0)" class="scroll"
                  >Alert with Link and Solid Color</a
                >
              </li>
              <li>
                <a @click="scrollView(10)" href="javascript:void(0)" class="scroll"
                  >Inline Notifications</a
                >
              </li>
              <li>
                <a @click="scrollView(11)" href="javascript:void(0)" class="scroll"
                  >Alert Icon Left</a
                >
              </li>
              <li>
                <a @click="scrollView(12)" href="javascript:void(0)" class="scroll"
                  >Alert outline</a
                >
              </li>
              <li>
                <a @click="scrollView(13)" href="javascript:void(0)" class="scroll">Alert Social</a>
              </li>
              <li>
                <a @click="scrollView(14)" href="javascript:void(0)" class="scroll"
                  >Message Alert</a
                >
              </li>
              <li>
                <a @click="scrollView(15)" href="javascript:void(0)" class="scroll"
                  >Message Alert Color</a
                >
              </li>
              <li>
                <a @click="scrollView(16)" href="javascript:void(0)" class="scroll"
                  >Alert left icon big
                </a>
              </li>
            </ul>
