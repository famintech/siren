<template>
  <CommonNavbar page="Bootstrap" path="Card" />
    ...
    <div class="element-area">
      <div class="demo-view">
        <div class="container-fluid pt-0 ps-0 pe-lg-4 pe-0">
          <div class="row">
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="card-title-1">
                ...
                <div class="tab-content" id="myTabContent">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;div class="card" id="card-title-1"&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="card-title-2">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-1" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-1"
                        data-bs-toggle="tab"
                        data-bs-target="#CardTitle2-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent-1">
                  ...
                  >
                    <div class="card-body pt-0">
                      <p class="card-text">
                        This is a wider card with supporting text and below as a natural lead-in to
                        the additional content. This content is a little <br />
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;div class="card" id="card-title-2"&gt;
...
&lt;/div&gt;    
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian text-center" id="card-title-3">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-2" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-2"
                        data-bs-toggle="tab"
                        data-bs-target="#CardTitle3-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent-2">
                  ...
                  >
                    <div class="card-body pt-0">
                      <p class="card-text">
                        This is a wider card with supporting text and below as a natural lead-in to
                        the additional content. This content
                      </p>
                      <a href="javascript:void(0);" class="btn btn-primary text-white"
                        >Go somewhere</a
                      >
                  ...
                  >
                    <div class="card-body p-0 code-area text-start">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;div class="card text-center" id="card-title-3"&gt;
    &lt;div class="card-header "&gt;
        &lt;h5 class="card-title"&gt;Card Title&lt;/h5&gt;
    &lt;/div&gt;
    &lt;div class="card-body"&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian text-center" id="special-title">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-4" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-4"
                        data-bs-toggle="tab"
                        data-bs-target="#TitleTreatment-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent-4">
                  ...
                  >
                    <div class="card-body pt-0 custom-tab-1">
                      ...
                      <a href="javascript:void(0);" class="btn btn-primary text-white btn-card"
                        >Go somewhere</a
                      >
                    </div>
                  </div>
                  ...
                  >
                    <div class="card-body p-0 code-area text-start">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;div class="card text-center" id="special-title"&gt;
    &lt;div class="card-header "&gt;
        &lt;h5 class="card-title"&gt;Special title treatment&lt;/h5&gt;
    &lt;/div&gt;
...
&lt;/div&gt;    
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian bg-primary text-white" id="primary-card">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs style-2" id="myTab-5" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-5"
                        data-bs-toggle="tab"
                        data-bs-target="#Primarycard-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent-5">
                  ...
                  >
                    <div class="card-body pt-0 mb-0">
                      ...
                      <a href="javascript:void(0);" class="btn bg-white text-primary btn-card"
                        >Go somewhere</a
                      >
                    </div>
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;div class="card dz-card bg-primary text-white" id="primary-card"&gt;
    &lt;div class="card-header "&gt;
        &lt;h5 class="card-title text-white"&gt;Primary card&lt;/h5&gt;
    &lt;/div&gt;
...
&lt;/div&gt;
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian bg-secondary text-white" id="secondary-card">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-6" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-6"
                        data-bs-toggle="tab"
                        data-bs-target="#Secondarycard-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent-6">
                  ...
                  >
                    <div class="card-body pt-0 mb-0">
                      ...
                      <a href="javascript:void(0);" class="btn bg-white text-secondary btn-card"
                        >Go somewhere</a
                      >
                    </div>
                    <div class="card-footer bg-transparent border-0 text-white">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;div class="card dz-card bg-secondary text-white" id="secondary-card"&gt;
    &lt;div class="card-header "&gt;
        &lt;h5 class="card-title text-white"&gt;Secondary card title&lt;/h5&gt;
    &lt;/div&gt;
    &lt;div class="card-body mb-0"&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian bg-success text-white" id="success-card">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs style-2" id="myTab-7" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-7"
                        data-bs-toggle="tab"
                        data-bs-target="#Successcard-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent-7">
                  ...
                  >
                    <div class="card-body pt-0 mb-0">
                      ...
                      <a href="javascript:void(0);" class="btn bg-white text-success btn-card"
                        >Go somewhere</a
                      >
                    </div>
                    <div class="card-footer bg-transparent border-0 text-white">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;div class="card dz-card bg-success text-white" id="success-card"&gt;
    &lt;div class="card-header "&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian bg-danger text-white" id="danger-card">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs style-2" id="myTab-8" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-8"
                        data-bs-toggle="tab"
                        data-bs-target="#Dangercard-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent-8">
                  ...
                  >
                    <div class="card-body pt-0 mb-0">
                      ...
                      <a href="javascript:void(0);" class="btn bg-white text-danger btn-card"
                        >Go somewhere</a
                      >
                    </div>
                    <div class="card-footer bg-transparent border-0 text-white">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;div class="card dz-card bg-danger text-white" id="danger-card"&gt;
    &lt;div class="card-header "&gt;
        &lt;h5 class="card-title text-white"&gt;Danger card&lt;/h5&gt;    
    &lt;/div&gt;
    &lt;div class="card-body mb-0"&gt;
...
&lt;/div&gt; </code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian bg-warning text-white" id="warning-card">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs style-2" id="myTab-9" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-9"
                        data-bs-toggle="tab"
                        data-bs-target="#Warningcard-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent-9">
                  ...
                  >
                    <div class="card-body pt-0 mb-0">
                      ...
                      <a href="javascript:void(0);" class="btn bg-white text-warning btn-card"
                        >Go somewhere</a
                      >
                    </div>
                    <div class="card-footer bg-transparent border-0 text-white">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;div class="card dz-card bg-warning text-white" id="warning-card"&gt;
		&lt;div class="card-header "&gt;
			&lt;h5 class="card-title text-white"&gt;Warning card&lt;/h5&gt;
		&lt;/div&gt;
		&lt;div class="card-body mb-0"&gt;
	...
	&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian bg-info text-white" id="info-card">
                <div class="card-header flex-wrap">
                ...
                <div class="tab-content" id="myTabContent-10">
                  ...
                  >
                    <div class="card-body pt-0 mb-0">
                      ...
                      <a href="javascript:void(0);" class="btn bg-white text-info btn-card"
                        >Go somewhere</a
                      >
                    </div>
                    <div class="card-footer bg-transparent border-0 text-white">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;div class="card dz-card bg-info text-white" id="info-card"&gt;
    &lt;div class="card-header "&gt;
        &lt;h5 class="card-title text-white"&gt;Info card&lt;/h5&gt;
    &lt;/div&gt;
    &lt;div class="card-body mb-0"&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian bg-light text-black" id="light-card">
                <div class="card-header flex-wrap">
                ...
                <div class="tab-content" id="myTabContent-11">
                  ...
                  >
                    <div class="card-body pt-0 mb-0">
                      ...
                      <a href="javascript:void(0);" class="btn bg-white text=black btn-card"
                        >Go somewhere</a
                      >
                    </div>
                    <div class="card-footer bg-transparent border-0">Last updateed 3 min ago</div>
                  </div>
                  <div
                    class="tab-pane fade"
                    id="Lightcard-html"
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      ><code class="language-html">&lt;div class="card dz-card bg-light text-black " id="light-card"&gt;
    &lt;div class="card-header "&gt;
        &lt;h5 class="card-title"&gt;Light card&lt;/h5&gt;
    &lt;/div&gt;
    &lt;div class="card-body mb-0"&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Column  -->
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian bg-dark text-white" id="dark-card">
                <div class="card-header flex-wrap">
                ...
                <div class="tab-content" id="myTabContent-12">
                  ...
                  >
                    <div class="card-body pt-0 mb-0">
                      ...
                      <a href="javascript:void(0);" class="btn bg-white text-dark btn-card"
                        >Go somewhere</a
                      >
                    </div>
                    <div class="card-footer bg-transparent border-0 text-white">
                  ...
                  >
                    <div class="card-body p-0 code-area">
                      <pre
                        class="m-0"
                      > <code class="language-html">&lt;div class="card dz-card bg-dark text-white" id="dark-card"&gt;
		&lt;div class="card-header "&gt;
			&lt;h5 class="card-title text-white"&gt;Dark card&lt;/h5&gt;
		&lt;/div&gt;
		&lt;div class="card-body mb-0"&gt;
	...
	&lt;/div&gt; </code></pre>
            ...
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian overflow-hidden" id="card-title-4">
                <img
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-13" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-13"
                        data-bs-toggle="tab"
                        data-bs-target="#CardTitle4-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
	...
	&lt;/div&gt;</code></pre>
            ...
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian overflow-hidden" id="card-title-5">
                <img
                  class="card-img-top img-fluid"
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-14" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-14"
                        data-bs-toggle="tab"
                        data-bs-target="#CardTitle5-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
...
&lt;/div&gt; </code></pre>
            ...
            <div class="col-xl-12">
              <div class="card dz-card scrollAccordian" id="card-title-6">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-15" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button
                        ...
                        id="profile-tab-15"
                        data-bs-toggle="tab"
                        data-bs-target="#CardTitle6-html"
                        type="button"
                        role="tab"
                        aria-selected="false"
                      >
                ...
                <div class="tab-content" id="myTabContent-15">
                  ...
                  >
                    <div class="card-body pt-0">
                      <p class="card-text">
                        This is a wider card with supporting text and below as a natural lead-in to
                        the additional content. This content is a little
                      </p>
                    </div>
                    <img
		...
		&lt;/div&gt;
		&lt;img class="card-img-bottom img-fluid" src="../../assets/images/card/3.png" alt="Card image cap"&gt;
		&lt;div class="card-footer"&gt;
			&lt;p class="card-text d-inline"&gt;Card footer&lt;/p&gt;
			&lt;a href="javascript:void(0);" class="card-link float-end"&gt;Card link&lt;/a&gt;
		&lt;/div&gt;
        ...
        <div class="demo-right-inner dz-scroll" id="right-sidebar">
          ...
          <div class="dz-scroll demo-right-tabs" id="rightSidebarScroll">
            <ul class="navbar-nav" id="menu-bar">
              <li><a @click="scrollView(0)" class="scroll">Card Title</a></li>
              <li><a @click="scrollView(1)" class="scroll">Card Title-2</a></li>
              <li><a @click="scrollView(2)" class="scroll">Card Title-3</a></li>
              <li><a @click="scrollView(3)" class="scroll">Special Title Treatment</a></li>
              <li><a @click="scrollView(4)" class="scroll">primary-card</a></li>
              <li><a @click="scrollView(5)" class="scroll">Secondary Card</a></li>
              <li><a @click="scrollView(6)" class="scroll">Success Card</a></li>
              <li><a @click="scrollView(7)" class="scroll">Danger Card</a></li>
              <li><a @click="scrollView(8)" class="scroll">Warning card</a></li>
              <li><a @click="scrollView(9)" class="scroll">Info card</a></li>
              <li><a @click="scrollView(10)" lass="scroll">Light card</a></li>
              <li><a @click="scrollView(11)" lass="scroll">Dark card title</a></li>
              <li><a @click="scrollView(12)" class="scroll">Card Title-4</a></li>
              <li><a @click="scrollView(13)" class="scroll">Card Title-5</a></li>
              <li><a @click="scrollView(14)" class="scroll">Card Title-6</a></li>
            </ul>
          </div>
        </div>
      </div>
