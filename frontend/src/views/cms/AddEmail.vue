<template>
  <div class="container-fluid">
    <div class="row">
      <div class="col-xl-12">
        <RouterLink to="/email-template" class="btn btn-primary mb-3">List Email Template</RouterLink>
      </div>
      <div class="col-xl-12">
        <div class="filter cm-content-box box-primary">
          <div class="content-title">
            <div class="cpa"><i class="fa-solid fa-envelope me-1"></i>Add Email Template</div>
            <div class="tools">
...
export default defineComponent({
  name: "addEmail",
  components: { ckeditor: CKEditor.component, RouterLink },
  setup() {
