<template>
  <CommonNavbar page="CMS" path="Blog Category" />
        ...
        <div class="row">
          <div class="col-xl-4">
            <div class="filter cm-content-box box-primary">
              ...
              <div class="cm-content-body form excerpt collapse show" id="BlogCategory">
                <div class="card-body">
                  <div class="mb-3">
          ...
          <div class="col-xl-8">
            <div class="filter cm-content-box box-primary">
              ...
              <div class="cm-content-body publish-content form excerpt collapse show" id="BlogList">
                <div class="card-body">
