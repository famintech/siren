<template>
  <CommonNavbar page="CMS" path="Menu" />
  <div class="container-fluid">
    <div class="row">
      <div class="col-xl-12">
        <div class="filter cm-content-box box-primary">
          <div class="content-title">
            <div class="cpa"><i class="fa fa-list-alt me-1"></i>Menus</div>
            <div class="tools">
              <a
                ...
                role="button"
                aria-expanded="false"
                aria-controls="menuCollapese"
                ><i class="fal fa-angle-down"></i
              ></a>
            </div>
          </div>
          <div id="menuCollapese" class="cm-content-body form excerpt collapse show">
            <div class="card-body">
              <div class="row align-items-center p-3">
                ...
                <div class="col-xl-6 col-xxl-5 mb-xl-0 mb-3">
                  <CustomSelectOption2
                    valueOne="Select Menu"
                    valueTwo="India"
                    valueThree="Information"
                    valueFour="New Menu"
                    valueFive="Page Menu"
                  />
                </div>
              ...
              <div class="content-title">
                ...
                <div class="tools">
                  <a
                    ...
                    role="button"
                    aria-expanded="false"
                    aria-controls="menuCollapese2"
                    ><i class="fal fa-angle-down"></i
                  ></a>
                </div>
              </div>
              <div class="cm-content-body form excerpt collapse show" id="menuCollapese2">
                <div class="card-body">
                  <div class="filter cm-content-box box-primary border">
                    <div class="content-title border-0">
                      <div class="cpa">page</div>
                      <div class="tools">
                        <a
                          class="expand SlideToolHeader"
                          data-bs-toggle="collapse"
                          ...
                          role="button"
                          aria-expanded="false"
                          aria-controls="menuCollapese3"
                          ><i class="fal fa-angle-down"></i
                        ></a>
                      </div>
                    </div>
                    <div
                      class="cm-content-body form excerpt border-top collapse show"
                      id="menuCollapese3"
                    >
                        ...
                        <ul class="tab-my nav nav-tabs" id="myTab" role="tablist">
                          <li class="nav-item" role="presentation">
                            <button
                              ...
                              id="Viewall-tab"
                              data-bs-toggle="tab"
                              data-bs-target="#Viewall-tab-pane"
                              type="button"
                              role="tab"
                              aria-controls="Viewall-tab-pane"
                              aria-selected="true"
                            >
                              View All
                            </button>
                        ...
                        <div class="tab-content" id="myTabContent">
                          ...
                          <div class="d-flex align-items-center flex-wrap">
                            <a
                              ...
                              class="checkAllInput"
                              @click="checkAllInput = true"
                              >Select All</a
                            ><span class="mx-2">|</span>
                            <a
                              href="javascript:void(0);"
                              class="unCheckAllInput"
                              @click="checkAllInput = false"
                              >Deselect All</a
                            >
                          </div>
          ...
          <div class="col-xl-8">
            <div class="filter cm-content-box box-primary">
              <div class="content-title flex-wrap">
                ...
                <button type="button" class="btn btn-secondary light ms-sm-auto mb-2 mb-sm-0">
                  Save Menu
                </button>
              </div>
                          ...
                          <div class="accordion" id="accordionExample-1">
                            <div class="accordion-item">
                              <div class="accordion-header p-0" id="heading-1">
                                ...
                                <button
                                  class="accordion-button contact"
                                  type="button"
                                  data-bs-toggle="collapse"
                              ...
                              >
                                <div class="accordion-body">
                                  <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                      <p class="dz-terms">
                                        Original: <a href="javascript:void(0);">Privacy Policy</a>
                                      </p>
                                    </div>
                                    <div class="d-flex align-items-center">
                                      <a href="javascript:void(0);">Remove</a
                              ...
                              >
                                <div class="accordion-body">
                                  <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                      <p class="dz-terms">
                                        Original: <a href="javascript:void(0);">About Us</a>
                                      </p>
                                    </div>
                                    <div class="d-flex align-items-center">
                                      <a href="javascript:void(0);">Remove</a
...
import CustomSelectOption2 from '@/components/CustomSelectOption2.vue'
...
export default defineComponent({
  name: 'menu_',
  setup() {
    const checkAllInput = ref(false)
    return { checkAllInput }
  },
  data() {
    return { dragging: false }
  },
  components: { CustomSelectOption2, CommonNavbar, draggable: VueDraggableNext }
})
</script>
