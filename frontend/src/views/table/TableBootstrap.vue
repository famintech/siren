<template>
  <CommonNavbar page="Bootstrap" path="Bootstrap Table" />
                ...
                <div class="card-header flex-wrap border-0">
                  <div>
                    ...
                    <p class="m-0 subtitle">
                      Recent Payments Queue. Add <code>table boootrstap</code> class in root
                    </p>
                  </div>
            ...
            <div class="card dz-card" id="bootstrap-table2">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                  ...
                  <p class="m-0 subtitle">
                    Exam Toppers. Add class <code>exam</code> with the class
                    <code> bootstrap-table</code>
                  </p>
                </div>
	...
	&lt;table class="table table-responsive-md"&gt;
		...
		&lt;tbody&gt;
			&lt;tr&gt;
				...
				&lt;td&gt;
					&lt;div class="d-flex align-items-center"&gt;
						&lt;img src="../../assets/images/avatar/1.jpg" class="rounded-lg me-2" width="24" alt=""&gt;
						&lt;span class="w-space-no"&gt;Dr. Jackson&lt;/span&gt;
					&lt;/div&gt;
				&lt;/td&gt;
				&lt;td&gt;example@example.com	&lt;/td&gt;
			...
			&lt;tr&gt;
				...
				&lt;/td&gt;
				&lt;td&gt;&lt;strong&gt;542&lt;/strong&gt;&lt;/td&gt;
				&lt;td&gt;&lt;div class="d-flex align-items-center"&gt;&lt;img src="../../assets/images/avatar/2.jpg" class="rounded-lg me-2" width="24" alt=""&gt; &lt;span class="w-space-no"&gt;Dr. Jackson&lt;/span&gt;&lt;/div&gt;&lt;/td&gt;
				&lt;td&gt;example@example.com	&lt;/td&gt;
				&lt;td&gt;01 August 2020&lt;/td&gt;
			...
			&lt;tr&gt;
				...
				&lt;/td&gt;
				&lt;td&gt;&lt;strong&gt;542&lt;/strong&gt;&lt;/td&gt;
				&lt;td&gt;&lt;div class="d-flex align-items-center"&gt;&lt;img src="../../assets/images/avatar/3.jpg" class="rounded-lg me-2" width="24" alt=""&gt; &lt;span class="w-space-no"&gt;Dr. Jackson&lt;/span&gt;&lt;/div&gt;&lt;/td&gt;
				&lt;td&gt;example@example.com	&lt;/td&gt;
				&lt;td&gt;01 August 2020&lt;/td&gt;
            ...
            <div class="card dz-card" id="bootstrap-table3">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                  ...
                  <p class="m-0 subtitle">
                    Add <code>basic</code> class with <code>bootsrtap-table</code>
                  </p>
                </div>
            ...
            <div class="card dz-card" id="bootstrap-table4">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                  ...
                  <p class="m-0 subtitle">
                    Add <code>table striped</code> class with <code>bootsrtap-table</code>
                  </p>
                </div>
                      ...
                      <table class="table table-striped table-responsive-sm">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th>2</th>
                            <td>Kolor Tea Shirt For Women</td>
                            <td><span class="badge badge-success light">Tax</span></td>
                            <td>January 30</td>
                            <td class="color-success">$55.32</td>
                          </tr>
                          <tr>
            ...
            <div class="card dz-card" id="bootstrap-table5">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                  ...
                  <p class="m-0 subtitle">
                    Add <code>table bordered</code> class with <code>bootsrap-table</code>
                  </p>
                </div>
            ...
            <div class="card dz-card" id="bootstrap-table6">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                  ...
                  <p class="m-0 subtitle">
                    Add <code>table hover</code> class with <code>bootsrap-table</code>
                  </p>
                </div>
                <ul class="nav nav-tabs dzm-tabs" id="myTab-115" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      id="profile-tab-115"
                      data-bs-toggle="tab"
                      data-bs-target="#leftPosition-html1"
                      type="button"
                      role="tab"
                      aria-selected="false"
                    >
                      ...
                      <table class="table table-hover table-responsive-sm">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th>3</th>
                            <td>Blue Backpack For Baby</td>
                            <td><span class="badge badge-danger light">Extended</span></td>
                            <td>January 25</td>
                            <td class="text-danger">$14.85</td>
                          </tr>
                        </tbody>
            ...
            <div class="card dz-card" id="bootstrap-table7">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                  ...
                  <p class="m-0 subtitle">
                    Add <code>hover table</code> class with <code>bootsrtap-table</code>
                  </p>
                </div>
                      ...
                      <table class="table header-border table-hover verticle-middle">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <div class="progress" style="background: rgba(127, 99, 244, 0.1)">
                          ...
                          <tr>
                            ...
                            <td>Textiles</td>
                            <td>
                              <div class="progress" style="background: rgba(76, 175, 80, 0.1)">
                                <div
                          ...
                          <tr>
                            ...
                            <td>Milk Powder</td>
                            <td>
                              <div class="progress" style="background: rgba(70, 74, 83, 0.1)">
                                <div
                          ...
                          <tr>
                            ...
                            <td>Vehicles</td>
                            <td>
                              <div class="progress" style="background: rgba(255, 87, 34, 0.1)">
                                <div
                          ...
                          <tr>
                            ...
                            <td>Boats</td>
                            <td>
                              <div class="progress" style="background: rgba(255, 193, 7, 0.1)">
                                <div
            ...
            <div class="card dz-card" id="bootstrap-table8">
              <div class="card-header flex-wrap d-flex justify-content-between">
                <div>
                  <h4 class="card-title">Table Bordered</h4>
                  <p class="m-0 subtitle">
                    Add <code>table bordered</code> class with <code>bootsrtap-table</code>
                  </p>
                </div>
                <ul class="nav nav-tabs dzm-tabs" id="myTab-5" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      id="profile-tab-5"
                      data-bs-toggle="tab"
                      data-bs-target="#widthicon-html-1"
                      type="button"
                      role="tab"
                      aria-selected="false"
                    >
            ...
            <div class="card dz-card" id="bootstrap-table9">
              <div class="card-header flex-wrap d-flex justify-content-between">
                <div>
                  ...
                  <p class="m-0 subtitle">
                    Add <code>bordered table</code> class with <code>bootsrap-table</code>
                  </p>
                </div>
            ...
            <div class="card dz-card" id="bootstrap-table10">
              <div class="card-header flex-wrap d-flex justify-content-between">
                <div>
                  ...
                  <p class="m-0 subtitle">
                    Add class <code>table stripeed</code> with <code>bootsrap-table</code>
                  </p>
                </div>
                      ...
                      >
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>May 18,2018</td>
                            <td><span class="badge badge-dark">70%</span></td>
                            <td>
                              <span
                                ><a
                                  href="javascript:void(0);"
            ...
            <div class="card dz-card" id="bootstrap-table11">
              <div class="card-header flex-wrap d-flex justify-content-between">
                <div>
                  ...
                  <p class="m-0 subtitle">
                    Add class <code>responsive table</code> with <code>bootstrap-table</code>
                  </p>
                </div>
                  ...
                  <div class="card-body pt-0">
                    <div class="table-responsive">
                      <table class="table header-border table-responsive-sm">
                        ...
                        <tbody>
                          <tr>
                            <td><a href="javascript:void();">Order #26589</a></td>
                            <td>Herman Beck</td>
                          ...
                          <tr>
                            <td><a href="javascript:void();">Order #58746</a></td>
                            <td>Mary Adams</td>
                            <td><span class="text-muted">Oct 12, 2017</span></td>
                            <td>$245.30</td>
                            <td><span class="badge badge-info light">Shipped</span></td>
                            <td>CN</td>
                          </tr>
                          <tr>
                            <td><a href="javascript:void();">Order #98458</a></td>
                            <td>Caleb Richards</td>
                            <td><span class="text-muted">May 18, 2017</span></td>
                            <td>$38.00</td>
                            <td><span class="badge badge-danger">Shipped</span></td>
                            <td>AU</td>
                          </tr>
                          <tr>
                            <td><a href="javascript:void();">Order #32658</a></td>
                            <td>June Lane</td>
                            <td><span class="text-muted">Apr 28, 2017</span></td>
                            <td>$77.99</td>
                            <td><span class="badge badge-success">Paid</span></td>
                            <td>FR</td>
                          </tr>
            ...
            <div class="card dz-card" id="bootstrap-table12">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                  ...
                  <p class="m-0 subtitle">
                    Add <code>heading with background</code> and <code>heading</code> class with
                    <code>bootsrtap-table</code>
                  </p>
                </div>
            ...
            <div class="card dz-card" id="bootstrap-table13">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                  ...
                  <p class="m-0 subtitle">
                    Add <code>primary table</code> class with <code>bootsrap-table</code>
                  </p>
                </div>
            ...
            <div class="card dz-card" id="bootstrap-table14">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                  ...
                  <p class="m-0 subtitle">
                    Add <code>primary table hover</code> class with <code>bootsrap-table</code>
                  </p>
                </div>
            ...
            <div class="card dz-card" id="bootstrap-table15">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                <div>
                  ...
                  <p class="m-0 subtitle">
                    Add <code>contextual table</code> class with <code>bootsrap-table</code>
                  </p>
                </div>
