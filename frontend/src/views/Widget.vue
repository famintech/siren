<template>
  <CommonNavbar page="Widget" path="Statistics" />
  <div class="container-fluid">
    <div class="row">
          ...
          <div class="card-body p-0">
            <div id="DZ_W_Todo3" class="widget-media dz-scroll height370 my-4 px-4">
              <ul class="timeline">
                <li>
                  <div class="timeline-panel">
                    ...
                    <div class="media-body">
                      ...
                      <a href="#" class="btn btn-primary btn-xxs shadow me-2">Reply</a>
                ...
                <li>
                  <div class="timeline-panel">
                    <div class="media me-2 media-danger">PU</div>
                    <div class="media-body">
            ...
            <div class="students1 d-flex align-items-center justify-content-between flex-wrap">
              ...
              <div>
                <div class="d-inline-block position-relative donut-chart-sale mb-2">
                  <span class="donut1" style="display: none">5/7</span
                  ><svg class="peity" height="80" width="80">
                    <path
                      d="M 40 0 A 40 40 0 1 1 1.0028835127270526 48.90083735825258 L 7.827378897999822 47.34319082055838 A 33 33 0 1 0 40 7"
                      data-value="5"
                      fill="rgb(59, 215, 225)"
                    ></path>
                    <path
                      d="M 1.0028835127270526 48.90083735825258 A 40 40 0 0 1 39.99999999999999 0 L 39.99999999999999 7 A 33 33 0 0 0 7.827378897999822 47.34319082055838"
                      data-value="2"
            ...
            <div class="students1 d-flex align-items-center justify-content-between flex-wrap">
              ...
              <div>
                <div class="d-inline-block position-relative donut-chart-sale mb-2">
                  <span
                    class="donut1"
                    data-peity='{ "fill": ["rgb(255, 97, 117)", "rgba(245, 245, 245, 1"],   "innerRadius": 33, "radius": 10}'
                    style="display: none"
                    >5/8</span
                  ><svg class="peity" height="80" width="80">
                    <path
                      d="M 40 0 A 40 40 0 1 1 11.715728752538102 68.2842712474619 L 16.665476220843935 63.33452377915607 A 33 33 0 1 0 40 7"
                      data-value="5"
                      fill="rgb(255, 97, 117)"
                    ></path>
                    <path
                      d="M 11.715728752538102 68.2842712474619 A 40 40 0 0 1 39.99999999999999 0 L 39.99999999999999 7 A 33 33 0 0 0 16.665476220843935 63.33452377915607"
                      data-value="3"
                      fill="rgba(245, 245, 245, 1"
                    ></path>
                  </svg>
        ...
        <div class="card overflow-hidden">
          <div class="card-body">
            <div class="text-center">
              ...
              <a class="btn btn-outline-primary btn-rounded mt-3 px-5" href="javascript:void();"
                >Folllow</a
              >
            </div>
          </div>
      ...
      <div class="col-xl-4 col-lg-12 col-sm-12">
        <div class="card overflow-hidden">
          <div
            class="text-center p-3 overlay-box"
            :style="`background-image: url(${IMAGE.bigImg1})`"
          >
            <div class="profile-photo">
              <img
                src="../assets/images/profile/profile.png"
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between">
              <span class="mb-0">Patient Gender</span> <strong class="">Female </strong>
            </li>
            <li class="list-group-item d-flex justify-content-between">
              <span class="mb-0">Years Old</span> <strong class="">Age: 24 </strong>
            </li>
          </ul>
      ...
      <div class="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
        <div class="card text-white bg-primary">
          <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between">
              <span class="mb-0">Blood type :</span><strong>O+</strong>
            </li>
            <li class="list-group-item d-flex justify-content-between">
              <span class="mb-0">Allergies :</span><strong>Penicilin, peanuts </strong>
            </li>
            <li class="list-group-item d-flex justify-content-between">
              <span class="mb-0">Pressure :</span><strong>120/100 mmHG</strong>
            </li>
            <li class="list-group-item d-flex justify-content-between">
              <span class="mb-0">Diseases :</span><strong>Diabetes</strong>
            </li>
            <li class="list-group-item d-flex justify-content-between">
              <span class="mb-0">Temperture :</span><strong>34 Degree</strong>
            </li>
          </ul>
        </div>
      </div>
      <div class="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
        <div class="card text-white bg-warning">
          <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between">
              <span class="mb-0">Regular Checkups</span>
            </li>
            <li class="list-group-item d-flex justify-content-between">
              <span class="mb-0">Dr Theodore Handle :</span><strong>Dentist</strong>
            </li>
            <li class="list-group-item d-flex justify-content-between">
              <span class="mb-0">Dr Valentino Morose :</span><strong>Surgeon</strong>
            </li>
            <li class="list-group-item d-flex justify-content-between">
              <span class="mb-0">Dr Fleece Marigold :</span><strong>Clinical</strong>
            </li>
            <li class="list-group-item d-flex justify-content-between">
              <span class="mb-0">Dr Eric Widget :</span><strong>Cardiology</strong>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-12 col-xxl-4 col-sm-12">
        <div class="card">
          <div class="card-body text-center ai-icon text-primary">
            ...
            <a href="javascript:void();;" class="btn my-2 btn-primary btn-lg px-4"
              ><i class="fa fa-usd"></i> Earn Budges</a
            >
          </div>
        </div>
      </div>
...
import SparkLineChart from '@/components/widgitData/SparkLineChart.vue'
import CommonNavbar from '@/layouts/CommonNavbar.vue'
import VisitorActivity from '@/components/widgitData/VisitorActivity.vue'
import ActiveUserChart from '@/components/widgitData/ActiveUserChart.vue'
import SparkBarChart from '@/components/widgitData/SparkBarChart.vue'
import WidgetChartjs from '@/components/widgitData/WidgetChartjs.vue'
